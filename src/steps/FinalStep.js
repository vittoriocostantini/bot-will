...
export async function handleFinalSteps(page, data, waitControl) {
  ...
  const result = await Promise.race([
    page.waitForSelector('text=/Our Records Show That You Already Have Lifeline|Decide if you want to/i', { visible: true, timeout: 35000 }).then(() => 'DUPLICADO'),
    ...
    page.waitForSelector('text=/You Qualify|approved', { visible: true, timeout: 35000 }).then(() => 'EXITO'),
